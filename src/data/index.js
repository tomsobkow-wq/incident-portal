...
// Contributing factor trends (last 90 days, counts)
...
// Risk heatmap (rows=likelihood 5→1, cols=consequence 1→5)
...
// Sparkline data (incidents per week, last 12 weeks)
...
export const TIMELINE = [
  { day: "11 April 2026", events: [
    { t: "14:00", kind: "action", title: "Train B scheduled maintenance outage begins", sub: "Planned 12-hour window" },
    { t: "21:30", kind: "action", title: "V-3201 inlet flange broken & gasket replaced", sub: "Work pack WO-84221 · Mech tech J. Park" },
    { t: "23:12", kind: "evidence", title: "Hydraulic torque report logged", sub: "Single-pass sequence recorded · no verifier signature" },
  ]},
  { day: "12 April 2026", events: [
    { t: "02:15", kind: "action", title: "Restart sequence initiated for Train B", sub: "Supervisor T. Harlow · inlet valve cracked open" },
    { t: "03:41", kind: "warning", title: "CG-B-114 reads 12% LEL, trends upward", sub: "DCS trend; no alarm threshold reached yet" },
    { t: "03:46", kind: "warning", title: "CG-B-112 reads 28% LEL", sub: "Operator notices trend, calls CCR" },
    { t: "03:47", kind: "trigger", title: "Hydrocarbon release · Tier-1 gas alarm", sub: "40% LEL · ESD-2 auto-initiates", root: true },
    { t: "03:50", kind: "action", title: "Muster called, POB accounted in 9 min", sub: "All 74 personnel mustered" },
    { t: "03:53", kind: "action", title: "Release stops as train depressures", sub: "Duration: 6 min · est. 13.8 kg release" },
    { t: "04:21", kind: "action", title: "BSEE initial notification submitted", sub: "Regulator acknowledgement received 04:38" },
    { t: "07:10", kind: "evidence", title: "Field photos & witness statements collected", sub: "3 witnesses on deck at time of event" },
  ]},
];
